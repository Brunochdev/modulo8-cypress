...
describe('Orange HRM Tests', () => {
  ...
  it('User Info Update - Fail - Username', () => {
    loginPage.accessLogin()
    loginPage.loginFailUser(userData.userFail.failField, userData.userSuccess.password)
    // cy.visit('/auth/login')
    // cy.get(selectorsList.userNameField).type(userData.userFail.failField)
    // cy.get(selectorsList.passwordField).type(userData.userSuccess.password)
    // cy.get(selectorsList.loginButton).click()
  ...
  it('User Info Update - Fail - Password', () => {
    loginPage.accessLogin()
    loginPage.loginFailUser(userData.userSuccess.name, userData.userFail.failField)
    // cy.visit('/auth/login')
    ...
    // cy.get(selectorsList.loginButton).click()
    // cy.get(selectorsList.wrongCredentials) //encontrado usando o CSS Selector
  })
})